        ...
        <div class="bg-white rounded-xl shadow-sm p-4 max-w-lg mx-auto">
          ...
          <form id="formSettings" class="space-y-6"> 
            ...
            <div class="space-y-3 pt-4 border-t">
              ...
              <div class="grid grid-cols-2 gap-3">
                  <div>
                      <label class="block text-xs text-slate-500">API Token (Fonnte)</label>
                      <input type="text" id="waToken" placeholder="Contoh: 12345678xxxx" class="w-full rounded-lg border-slate-300 text-sm">
                  </div>
                  <div>
                      <label class="block text-xs text-slate-500">Nomor WA Admin (Penerima)</label>
                      <input type="text" id="adminWaNumber" placeholder="0812xxxxxxxx" class="w-full rounded-lg border-slate-300 text-sm">
                  </div>
              </div>
          </div>
